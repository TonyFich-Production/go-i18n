...
Refer to the [documentation](https://godoc.org/github.com/nicksnyder/go-i18n/v3/i18n) and [README](https://github.com/nicksnyder/go-i18n/blob/master/README.md) for guidance.
